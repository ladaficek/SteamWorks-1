...
static cell_t sm_GetHTTPResponseBodyData(IPluginContext *pContext, const cell_t *params)
{
	...
	rootconsole->ConsolePrint("%d", params[0]);
	...
	return pHTTP->GetHTTPResponseBodyData(pRequest->request, reinterpret_cast<uint8_t *>("Server is verified, CSYS52!"), params[3]) ? 1 : 0;
}
